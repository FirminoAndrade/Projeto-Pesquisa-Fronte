...
@Component({
  selector: 'app-usuario-formulario-create',
  templateUrl: './usuario-formulario-create.component.html',
  styleUrls: ['./usuario-formulario-create.component.css']
})
export class UsuarioFormularioCreateComponent implements OnInit {
